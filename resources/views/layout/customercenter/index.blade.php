                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <input type="text" name="company" class="form-control"
                                                    placeholder="Company" aria-describedby="addon-wrapping">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <input type="text" name="telphone" class="form-control"
                                                    placeholder="Telephone" aria-describedby="addon-wrapping">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <input type="text" name="location" class="form-control"
                                                    placeholder="Location" aria-describedby="addon-wrapping">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <input type="text" name="size" class="form-control"
                                                    placeholder="Size" aria-describedby="addon-wrapping">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <input type="text" name="issue" class="form-control"
                                                    placeholder="Issue" aria-describedby="addon-wrapping">
                                            </div>
                                        </div>
                                    </div>
                                </div>
