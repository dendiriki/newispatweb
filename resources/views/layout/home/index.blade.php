...
<div id="home-carousel" class="carousel slide" data-ride="carousel">
 ...
 <section class="about_section layout_padding ">
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-sm-6">
          ...
          <div class="detail">
            <div class="container">
              <iframe allowfullscreen style="border-radius: 2px;" src="https://www.youtube.com/embed/f53DFw5KV14"></iframe>
            </div>
          </div>
   ...
   <section class="expert_section layout_padding">
    <div class="container">
      ...
      <div class="heading_container heading_center col-md-8">
        ...
        <p class="text-left">
          Our notable accomplishments and successes that we have attained over the years. These accomplishments reflect our dedication to excellence, innovation, and a commitment to
  ...
  <!-- Start Stat -->
  <section id="stat" class="parallax-bg overlay-dark p-top-80 p-bottom-40 white-color" style="background-image:url(assets/img/backround.png); height: 600px" data-stellar-background-ratio="0.5">

   <div class="content-below" style="margin-top: 50px; text-align: center; padding-top: 40px; padding-bottom: 100px;">
              ...
              <div class="heading_container col-md-12">
                ...
                <br>
                      ...
                      <div class="container_CS">
                        ...
                        <div id="content1">
                          <img src="assets/img/icon/Markicon.png" alt="icon" style="max-width: 6rem; padding: 15px;" >
                          <h1>Address</h1>
                        ...
                        <div id="content2">
                          <img src="assets/img/icon/Phoneicon.png" alt="icon" style="max-width: 6rem; padding: 15px;" >
                            <h1>Call Us</h1>
                        ...
                        <div id="content3">
                          <img src="assets/img/icon/Emailicon.png" alt="icon" style="max-width: 6rem; padding: 15px;" >
                            <h1>Email Us</h1>
                            <p>marketing.indo@mittalsteel.com <br>custsupp.indo@mittalsteel.com</p>
                        </div>

                        <div id="content4">
                          <img src="assets/img/icon/Clockicon.png" alt="icon" style="max-width: 6rem; padding: 15px;" >
                            <h1>Open Hours</h1>
