    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5">
            ...
            <H4>PT. Ispat Indo</H4>
            <p>
                Ispat Indo, a steel industry pioneer, redefines excellence, driving innovation and setting global standards.
            </p>
        </div>
        ...
        <div class="col-md-2 info_links">
          ...
          <ul>
            ...
            <li style="margin-bottom: 5px;">
              <a class="" href="mailto:hrd.indo@mittalsteel.com">
                Careers
              </a>
            </li>
            <li style="margin-bottom: 5px;">
              <a class="" href="mailto:webmaster.indo@mittalsteel.com">
                web master
              </a>
            </li>
            <li style="margin-bottom: 5px;">
