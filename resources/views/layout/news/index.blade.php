          ...
          <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
              <div class="card" style="margin: 5px; background: #f7f7f7;">
                <iframe allowfullscreen style="width :20rem; height: 11rem; margin: auto; border-radius: 7px; border: transparent;" src="https://www.youtube.com/embed/{{ $new->link }}"></iframe>
                <div class="card-body">
