    ...
    <div class="row">
      <div class="col-12">
        <div class="heading_container  p-bottom-40">
          <a href="{{ route('news_indo') }}" style="position: absolute; top: 50px; left: 10px; font-size: 1.4em ; color:black">
            <div class="row">
            <img src="{{ asset('assets/img/icon/fa-angel-left.png') }}" style="max-width: 1em; margin-right: 10px; ">
            back
